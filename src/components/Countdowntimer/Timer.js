            ...
            <div className="starticon">
                {isstarted?
                    <div className="startedbuttons">
                        <FontAwesomeIcon icon={faSquare} className="playbutton reset" onClick={handleReset}/>
                        {
                            iscompleted?
                            <FontAwesomeIcon icon={faRotateForward} className="playbutton reset" onClick={handleRestart}/>
                            :
                            <FontAwesomeIcon icon={ispaused? faPlay:faPause} className="playbutton reset" onClick={handleStart}/>
                        }
                    </div>
                    :
                    <FontAwesomeIcon icon={faPlay} className="playbutton" onClick={handleStart}/>
                }
            </div>
        </div>
    )
