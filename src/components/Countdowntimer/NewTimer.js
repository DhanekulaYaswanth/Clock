        ...
        <div  className="startingtimer">
                    <h1 className="newtimer">
                        ...
                        <div className="countdownlabels">
                            <p>{days===1?"Day":"Days"} </p>
                            <div className="countdownnumbers" style={{color:color[0]}}><FlipNumbers height={height} width={width} play  numbers={`${String("0" + days).slice(-2)}`}/></div>
                        ...
                        <div className="countdownlabels">
                            ...
                            <p className="countdownnumbers" style={{color:color[0]}}><FlipNumbers height={height} width={width} play numbers={`${String("0" + hours).slice(-2)}`}/></p> 
                        ...
                        <div className="countdownlabels">
                            ...
                            <p className="countdownnumbers" style={{color:color[0]}}><FlipNumbers height={height} width={width} play  numbers={`${String("0" + minutes).slice(-2)}`}/></p>
                        ...
                        <div className="countdownlabels">
                            ...
                            <p className="countdownnumbers" style={{color:color[0]}}><FlipNumbers  play  height={height} width={width} numbers={`${String("0" + seconds).slice(-2)}`} /></p>
                        </div>
                    </h1>
